...
public class ClienteChatTranporte extends JFrame {

    private Logger log = Logger.getLogger(ClienteChatTranporte.class);
    ...
    public static void main(String[] args) {
        ...
        ClienteChatTranporte c = new ClienteChatTranporte();
